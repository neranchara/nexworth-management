        ...
        <div className="relative z-10 mt-8">
          {!token ? (
            <div className="text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <h2 className="text-lg font-black text-white uppercase tracking-widest">{t('invite.invalidHeading')}</h2>
            ...
            <div className="text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <h2 className="text-lg font-black text-white uppercase tracking-widest mb-2">{t('invite.successHeading')}</h2>
            ...
            <div className="text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <h2 className="text-lg font-black text-white uppercase tracking-widest">{t('invite.errorHeading')}</h2>
